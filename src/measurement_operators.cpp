        ...
        fourier_kernels(const t_uint &imsizey_, const t_uint &imsizex_)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                for (int j = 0; j < n; j++)
                {
                    ...
                    if (2 * i - 2 < n)
                    {
                        ky = (static_cast<t_real>(i));
                    }
                    else
                    {
                        ky = (static_cast<t_real>(i - n));
                    }
                    if (2 * j - 2 < n)
                    {
                        kx = (static_cast<t_real>(j));
                    }
                    else
                    {
                        kx = (static_cast<t_real>(j - n));
                    }
                    if ((kx != 0.0) || (ky != 0.0))
                    {
